    ...
    <>
      <div className={hover ? styles.box : styles.boxActive}>
        <div className={styles.imgBack}>
          <img src={HomeBoxData[0].img} width="30" height="30" loading="lazy" />
        </div>
      ...
      >
        <div className={styles.imgBack}>
          <img src={HomeBoxData[1].img} width="30" height="30" loading="lazy" />
        </div>
      ...
      >
        <div className={styles.imgBack}>
          <img src={HomeBoxData[2].img} width="30" height="30" loading="lazy" />
        </div>
